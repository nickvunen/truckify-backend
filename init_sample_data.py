...
from database import SessionLocal, Camper, Attribute, Settings, Base, engine
    ...
    try:
        ...
        campers = [
            Camper(
                ...
                facilities=["Kitchen", "Shower", "Heating", "Pop-up Roof", "Solar Panel", "Fridge"],
            ...
            Camper(
                ...
                facilities=["Kitchen", "Heating", "Air Conditioning", "Awning", "Parking Sensors", "LED Lighting"],
            ...
            Camper(
                ...
                facilities=["Kitchen", "Shower", "Toilet", "Heating", "Large Bed", "Storage"],
            ...
            Camper(
                ...
                facilities=["Kitchen", "Heating", "Swivel Seats", "USB Charging", "LED Lights"],
                images=["https://images.unsplash.com/photo-1527847263472-aa5338d178b8?w=800"],
                max_passengers=2,
                year=2022,
                is_active=True
            ),
            Camper(
                ...
                facilities=["Kitchen", "Shower", "Solar Panel", "Bike Rack", "Outdoor Table", "Awning"],
